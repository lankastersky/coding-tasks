...
class Solution {
  // Based on https://leetcode.com/problems/sentence-screen-fitting/discuss/90845/21ms-18-lines-Java-solution
  public int wordsTyping(String[] sentence, int rows, int cols) {
    ...
    for (int i = 1; i < n; i++) {
      if (s.charAt(i) == ' ') {
        ...
        // store how many symbols back till next ' ' we need to make
